...
int main(int argc, char *argv[])
{
    ...
    matd_t I0;
    egl::readDMAT(inpath, I0);
    int num_nods = I0.rows() * I0.cols();
    int num_cels = (I0.rows() - 1) * (I0.cols() - 1) * 2;
    spdlog::info("precision:{} rows:{}, cols:{}, num_nods:{} num_cels:{}",
                 sizeof(Float), I0.rows(), I0.cols(), num_nods, num_cels);
    ...
    egl::writeDMAT(outdir + "u.dmat", u, false);
    pcg.write_profile((outdir + "err.txt").c_str(), "cg_residual");
